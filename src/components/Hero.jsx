  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      particles.forEach(p => {
        ...
        ctx.fillStyle = `rgba(37, 84, 224, ${p.alpha * 0.6})`;
        ctx.fill();
      });
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (dist < 120) {
            ...
            ctx.strokeStyle = `rgba(37, 84, 224, ${0.035 * (1 - dist / 120)})`;
            ctx.lineWidth = 0.5;
            ctx.stroke();
          }
        }
    ...
    <section id="hero" className="hero">
      ...
      <div className="hero__content">
        ...
        <div className="hero__actions animate-fadeInUp" style={{ animationDelay: '1s', opacity: 0 }}>
          ...
          <a href="/NanaYaw_odoiyeboah_cv.pdf" download className="btn btn--outline">
